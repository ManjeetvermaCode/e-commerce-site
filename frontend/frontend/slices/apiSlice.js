...
const baseQuery=fetchBaseQuery({baseUrl:BaseUrl})//handles the technical parts of sending and receiving messages between your frontend and backend. 'baseUrl' is the main address of application.

export const apiSlice=createApi({//is like a magical tool that helps you set up a way to talk to your backend server. it establishes a connection between frontend and backend.
    baseQuery,// This is like the default way of sending messages to the server. It knows how to talk to the server using common rules like sending and receiving data.(baseQuery is basically send and receive of data.)
